...
class CustomExpansionTile extends StatefulWidget {
  ...
  const CustomExpansionTile({
    ...
    this.showContentAtBottom = false,
  ...
  final Widget Function(bool isExpanded) titleBuilder;
  ...
  final bool showContentAtBottom;
...
class _CustomExpansionTileState extends State<CustomExpansionTile> with SingleTickerProviderStateMixin {
  ...
  void didUpdateWidget(covariant CustomExpansionTile oldWidget) {
    ...
    if (oldWidget.initiallyExpanded != widget.initiallyExpanded && widget.initiallyExpanded != _isExpanded) {
      _handleTap();
    }
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          InkWell(
            onTap: _handleTap,
            child: widget.titleBuilder(_isExpanded),
          ),
          if (widget.showContentAtBottom)
            ClipRect(
              child: Align(
